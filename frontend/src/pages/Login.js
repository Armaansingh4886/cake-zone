                ...
                <div className='bg-white p-5 w-full max-w-sm mx-auto'>
                    ...
                    <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit}>
                        ...
                        <div className="col-span-full ">
                            ...
                            <Link to={''} className='block w-fit ml-auto hover:underline hover:text-amber-600'>
                                Forgot password ?
                            </Link>
                        </div>
                        ...
                        <button className='bg-amber-500 hover:bg-amber-700 text-white px-6 py-2 w-full max-w-[150px] rounded-lg font-bold text-lg hover:scale-110 transition-all mx-auto block mt-6'>Login</button>

                    </form>

                    <p className='my-5'>Don't have account ? <Link to={"/sign-up"} className=' font-bold text-lg text-amber-500 hover:text-amber-700 hover:underline'>Sign up</Link></p>
                </div>
