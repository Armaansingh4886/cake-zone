...
import tcake from "../assest/banner/new/yummy.jpg"
import itcake from "../assest/banner/new/blackCake.jpg"
function About() {
  return (
    <div>
      ...
      <div class="flex flex-wrap items-center justify-between -mx-4">
         ...
         <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="mt-10 lg:mt-0">
               ...
               <p class="mb-5 text-base text-justify text-body-color dark:text-dark-6">
               ...
               <p class="mb-8 text-base text-justify text-body-color dark:text-dark-6">
