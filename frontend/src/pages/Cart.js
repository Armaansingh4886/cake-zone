    ...
    <div className=' container mx-auto'>
        ...
        <div className='flex flex-col mt-5 mb-5 lg:flex-row gap-10 lg:justify-between p-4'>   
                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm '>
                        {
                            loading ? (
                            <div className='h-36 bg-slate-200 rounded-xl border border-slate-300  animate-pulse'>
                                
                            </div>
                            ) : (
                                <div className='h-36 mb-10 bg-white rounded-lg '>
                                    <h2 className='text-white bg-amber-700 font-semibold text-xl  rounded-t-lg px-4 py-1'>Summary</h2>
                                    <div className='flex mt-4 mb-2  border-b-2 items-center justify-between px-4 gap-2 font-medium text-lg text-slate-700'>
                                        <p>Quantity</p>
                                        <p>{totalQty}</p>
                                    </div>

                                    <div className='flex items-center border-b-2 mb-4 justify-between px-4 gap-2 font-medium text-lg text-slate-700'>
                                        <p>Subtotal</p>
                                        <p>{displayINRCurrency(totalPrice)}</p>    
                                    </div>

                                    <button className='bg-amber-700 hover:bg-amber-500 p-2 font-semibold rounded-b-lg text-white text-xl w-full mt-2' onClick={e => navigate("/checkout")}>Proceed to Checkout</button>
